...
func _on_click() -> void:
	...
	await C.player.say("Not the right time to clean the coffee table.")
...
func _on_right_click() -> void:
	await C.player.face_clicked()
	await C.player.say("A glass coffee table.")
	await C.player.say("Not really the best thing with Popsy around the house.")
